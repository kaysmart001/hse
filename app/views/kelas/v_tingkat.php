...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<div class="row mb-2">
			<div class="col-md-12">
				<button class="btn btn-primary" data-toggle="modal" data-target="#modalAdd"><i class="fa fa-plus-circle"></i>&nbsp;Tambah Tingkat</button>
			</div>
		</div>
		<div class="row">
						...
						<tbody>
							<?php foreach($data['tingkat'] as $key => $tingkat) : ?>
								<tr>
									...
									<td><?php echo $tingkat['tingkat_nama']; ?></td>
									<td>
										<button 
											data-id="<?php echo $tingkat['tingkat_id']; ?>" 
											data-nama="<?php echo $tingkat['tingkat_nama']; ?>"
...
<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Delete Tingkat</h4>
      </div>
      <form action="" method="post">
      <div class="modal-body">
        <div class="form-group">
        	<h4 class="text-center">Anda yakin akan menghapus tingkat ini?</h4>
        	<input type="hidden" id="tingkat_id_delete" name="tingkat_id_delete" class="form-control">
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
...
<script type="text/javascript">
    ...
    function edit(obj) {
    	...
    	$('#tingkat_nama').val(obj.dataset.nama);
    	$('#tingkat_id').val(obj.dataset.id);
    };
    // Delete click
    function remove(obj) {
    	$('#modalDelete').modal('show');
    	$('#tingkat_id_delete').val(obj.dataset.id);
    };
</script>
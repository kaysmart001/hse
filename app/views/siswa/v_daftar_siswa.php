                            ...
                            <?php foreach($data['siswa'] as $key => $siswa) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-default btn-xs" data-id="<?php echo $siswa['siswa_id']; ?>" data-uid="<?php echo $siswa['siswa_uid']; ?>" onclick="hapus(this)"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url(); ?>siswa/delete_siswa" method="post">

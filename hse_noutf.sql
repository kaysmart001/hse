...
CREATE TABLE `tb_guru` (
  ...
  `guru_tgs_mengajar` varchar(255) DEFAULT '-',
  `guru_tgs_tambahan` int(11) DEFAULT NULL COMMENT '1 = kordinator - 2 = wali kelas - 3 = staff mngmnt - 4 = dll',
  `guru_riwayat_pend_sd` varchar(128) DEFAULT '-',
  `guru_riwayat_pend_smp` varchar(128) DEFAULT '-',
  `guru_riwayat_pend_sma` varchar(128) DEFAULT '-',
  `guru_riwayat_pend_pt` varchar(128) DEFAULT '-',
...
CREATE TABLE `tb_siswa` (
  ...
  `siswa_nama_panggilan` varchar(255) DEFAULT '-',
  ...
  `siswa_alamat` text,
  `siswa_nohp` varchar(125) DEFAULT '-',
  `siswa_jenjang_terakhir` varchar(125) DEFAULT '-',
  `siswa_gol_darah` varchar(125) DEFAULT '-',
  `siswa_hobi` varchar(125) DEFAULT '-',
  ...
  `siswa_pend_terakhir_ayah` varchar(125) DEFAULT '-',
  `siswa_pend_terakhir_ibu` varchar(125) DEFAULT '-',
  `siswa_nohp_ayah` varchar(125) DEFAULT '-',
  `siswa_nohp_ibu` varchar(125) DEFAULT '-',
  `siswa_email_ayah` varchar(125) DEFAULT '-',
  `siswa_email_ibu` varchar(125) DEFAULT '-',
  `siswa_penghasilan_ayah` varchar(125) DEFAULT '0',
  `siswa_penghasilan_ibu` varchar(125) DEFAULT '0',
